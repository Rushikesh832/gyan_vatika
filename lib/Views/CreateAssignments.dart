...
class CreateAssignments extends StatefulWidget {
  ...
  CreateAssignments(this.classificationId) : super();
  @override
...
class _CreateAssignmentsState extends State<CreateAssignments> {
  ...
  TextEditingController outDatedDays = new TextEditingController();
  ...
  async {
    ...
    if (formKey.currentState.validate()) {
      ...
      map['assignment_no'] = assignmentNo.text;
      map['assignment_name'] = assingmnetNameFinalFilter;
      map['assignment_content'] = assingmentContentFilterFinal;
      ...
      map['outdated_days'] = outDatedDays.text;
      ...
      if (responseData.statusCode == 200) {
        ...
        if (simpleResponse.status == 200) {
          ...
          Navigator.push(context, MaterialPageRoute(
              builder: (context) => TeacherAssignments(widget.classificationId)
          ));
        }
