...
import 'package:gyan_vatika/Views/StudentAssignments.dart';
...
class StudentAssignmentsSubjects extends StatefulWidget {
  @override
  _StudentAssignmentsSubjectsState createState() => _StudentAssignmentsSubjectsState();
}

class _StudentAssignmentsSubjectsState extends State<StudentAssignmentsSubjects> {
  ...
  loadSubjects() async {
    ...
    String uri = "http://navelsoft.com/gayan/studentsAssignmentsSubjects.php?standard=" + standardUrl.split(" ")[0]
    ...
    if (responseData.statusCode == 200) {
      ...
      //print(subjectsData.subjectsData);
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(
                        builder: (context) => StudentAssignments(subjectsData.subjectsData[i].subjectsId,this.standardUrl)
                    ));
                  },
                  child: Container(
                    child: Column(
